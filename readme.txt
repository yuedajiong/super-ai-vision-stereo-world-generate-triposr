...
4. check code in superv.py, comment or uncomment 'infer/train' lines.  (the infer code is fully compatible to official TripoSR,  the tarin code is configured for small network.)
